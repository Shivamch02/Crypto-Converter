  ...
  return (
    <div className='container'>
        <Card className='crypto-card '   title={<h1> <RiCoinsLine />Crypto Converter</h1>}>
            ...
            <Select style={{width: '200px'}} defaultValue={defaultFirstSelectValue}options={cryptoList} onChange={(value)=>setFirstSelect(value)}/>
            <Select style={{width: '200px'}} defaultValue={defaultSecondSelectValue}options={cryptoList} onChange={(value)=>setSecondSelect(value)}/>
            </div>
